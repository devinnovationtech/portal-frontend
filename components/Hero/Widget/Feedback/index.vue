<template>
  <div class="w-full max-w-xl">
    ...
    >
      <div class="group md:relative md:transform md:-rotate-90">
        <button
          class="w-full bg-white bg-opacity-5 backdrop-filter backdrop-blur-sm flex justify-center items-center gap-4 pl-3 pr-4 py-3 rounded-lg border-l border-b border-transparent
