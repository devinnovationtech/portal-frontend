<template>
  <section v-if="menus.length > 0" class="bg-white py-6 md:py-8 xl:py-12 md:px-4 xl:px-16">
    <BaseContainer>
      <ul class="grid md:grid-cols-3 md:grid-rows-[auto,1fr] md:gap-x-6 lg:gap-x-20 gap-y-6 lg:gap-y-12">
